...
class _AttendancePageState extends State<AttendancePage> {
  ...
  void initState() {
    ...
    // Cek perubahan siklus absensi secara berkala.
    _startAttendanceCycleWatcher();
  }
  ...
  // ============================================================
  // ATTENDANCE CYCLE WATCHER
  // ============================================================

  void _startAttendanceCycleWatcher() {
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Anda belum melakukan clock in pada siklus absensi ini.',
